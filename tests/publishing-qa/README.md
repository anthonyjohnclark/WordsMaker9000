...
```powershell
# Create the fourteen QA projects under the app's Dev_Projects directory.
...
# Generate all four PDF profiles, both DOCX profiles, and EPUB without opening the app.
